...
def print_usage_and_exit():
    ...
    print '  WARNING (and TODO!) : only works with types "aumu", "aufx" and "aumf" for now'
...
#    print au
    for i,p in enumerate(au.get_parameters()):
        ...
        if p.name != '': # let's skip unnamed params
